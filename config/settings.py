...
TELEGRAM_DELAY_SECONDS = 0  # No delay between Telegram messages
...
MORNING_GREETING_TIME = "06:00"         # Morning greeting with motivation
MORNING_NEWS_TIME = "07:00"          # Morning news posts
