...
from config.settings import DATA_DIR, MORNING_GREETING_TIME, MORNING_NEWS_TIME, EVENING_QUIZ_TIME, GOOD_NIGHT_TIME
...
def morning_greeting_pipeline():
    ...
    print('')
    print('=' * 55)
    print(f'   MORNING GREETING PIPELINE - {start.strftime("%H:%M:%S")}')
    print('=' * 55)
    ...
    try:
        ...
        if greeting:
            ...
            print('   WARNING: Could not generate morning greeting')
